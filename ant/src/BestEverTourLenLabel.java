...
class BestEverTourLenLabel extends Label implements Observer {
	public BestEverTourLenLabel(Network net) {
		super(String.valueOf(AntTSP.trim(net.getBestEverTourLen())));
		this.net = net;
		net.addObserver(this);
	}

	public void update(Observable o, Object arg) {
		setText(String.valueOf(AntTSP.trim(net.getBestEverTourLen())));
	}
